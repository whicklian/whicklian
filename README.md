...
<br clear="both"/>
<!-- ═══════════════════════════════════════════════════════════════════ --><!-- 🛠️ TECH STACK 🛠️ --><!-- ═══════════════════════════════════════════════════════════════════ --><h3 align="center">🛠️ &nbsp;Tech Stack & Toolbox</h3><div align="center">
🎨 Frontend
...
Google Cloud Platform (GCP) services	Microservices & API optimization	Responsive, user-centric design
Serverless & Cloud Run	RESTful & GraphQL APIs	Figma prototyping
Kubernetes basics	System Design patterns	Accessibility (a11y)
</div>
